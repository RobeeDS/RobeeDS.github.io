...
const Hero = () => {
  return (
    <div className={`font-poppins font-medium text-[64px] xl:text-[80px] flex flex-1`}>

        <div className={`flex flex-1 md:flex-row flex-col w-full`}>

            {/* Heading */}
            <div className={`flex flex-1 flex-col justify-center mt-6 ml-6`}>
                <p className='z-[5] text-white'>INNOVATE. <br/> ITERATE.</p>
                <p className='z-[5] text-blue'>INTERFACE MASTERY.</p>
                <p className='z-[5] text-white text-[33px]'> Websites for People with Purpose.</p>
